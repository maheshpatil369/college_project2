...
function Auth() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault(); // Form ko manually validate karenge
    const form = e.target;

    if (!form.checkValidity()) {
      form.reportValidity(); // Yaha browser ka default validation trigger hoga (jo tujhe chahiye)
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-[#0a0f14] flex items-center justify-center p-4">
      <div className="w-full max-w-[1000px] border border-gray-500 rounded-lg p-4 bg-[#1e8074] rounded-2xl overflow-hidden flex shadow-2xl">
        ...
        <div 
          className="border border-gray-700 rounded-lg p-16  hidden md:block w-1/2 bg-cover bg-center color"
          style={{
            backgroundImage: 'url("https://images.unsplash.com/photo-1574631091989-67a56586dacc?q=80&w=2030&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")'
          }}
        >
          <div className="h-full w-full #2B534F backdrop-blur-sm flex flex-col items-center justify-center text-white p-8">
            <h2 className="text-4xl font-bold mb-4">Hello, Friend!</h2>
            <p className="text-center mb-6">
              Enter your personal details and start your journey with us.
            </p>
